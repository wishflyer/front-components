				...
				<div id="marquee2">
					<ul>
							...
							<div className="panel-div">
								<div className="panel-content">
									<div className="col-24">
										<div className="col-6">
											<img src="/static/image/girls/girl1.jpg"></img>
										</div>
						...
						<li>
							<div className="panel-div">
								<div className="panel-content">
									<a target="_blank" href="#"><img src="/static/image/girls/girl0.jpg"></img></a>
								</div>
							</div>
						</li>
						<li>
							<div className="panel-div">
								<div className="panel-content">
									<a target="_blank" href="#"><img src="/static/image/girls/girl3.jpg"></img></a>
								</div>
							</div>
						</li>
					</ul>
