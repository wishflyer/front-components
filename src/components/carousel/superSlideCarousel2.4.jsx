		...
		return (
			<div className={"superSlide "+this.state.componentUUID}>
				...
				<div className="game163" style={{"margin":"0 auto"}}>
					<ul className="bigImg">
						<li>
							<a href="http://www.SuperSlide2.com" target="_blank"><img src="src/static/image/1.jpg" /></a>
							<h4 className="pictureTips"><a href="http://www.SuperSlide2.com" target="_blank">美女玩家猎魔人 Cosplay</a></h4>
						</li>
						<li>
							<a href="http://www.SuperSlide2.com" target="_blank"><img src="src/static/image/2.jpg" /></a>
							<h4 className="pictureTips"><a href="#">《第2次机战OG》魔装机神系机体情报</a></h4></li>
						<li>
							<a href="http://www.SuperSlide2.com" target="_blank"><img src="src/static/image/3.jpg" /></a>
							<h4 className="pictureTips"><a href="#">Dreamhack冬季赛：Hero夺冠 香槟狂欢</a></h4>
						</li>
						<li>
							<a href="http://www.SuperSlide2.com" target="_blank"><img src="src/static/image/4.jpg" /></a>
							<h4 className="pictureTips"><a href="#">妹子战丧尸！Bioware王牌画师插画赏</a></h4>
						</li>
						<li>
							<a href="http://www.SuperSlide2.com" target="_blank"><img src="src/static/image/5.jpg" /></a>
					...
					<div className="smallScroll">
						...
						<div className="smallImg">
								 <ul>
									<li><a><img src="src/static/image/1.jpg" /></a></li>
									<li><a><img src="src/static/image/2.jpg" /></a></li>
									<li><a><img src="src/static/image/3.jpg" /></a></li>
									<li><a><img src="src/static/image/4.jpg" /></a></li>
									<li><a><img src="src/static/image/5.jpg" /></a></li>
									<li><a><img src="src/static/image/1.jpg" /></a></li>
									<li><a><img src="src/static/image/2.jpg" /></a></li>
									<li><a><img src="src/static/image/3.jpg" /></a></li>
								</ul>
