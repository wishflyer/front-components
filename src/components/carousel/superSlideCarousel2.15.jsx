		...
		return (
			<div className="superSlide">
				<div className="focusBox" style={{"margin":"0 auto"}}>
					<ul className="pic">
							<li><a href="http://www.SuperSlide2.com" target="_blank"><img src="src/static/image/bigbar1.jpg"/></a></li>
							<li><a href="http://www.SuperSlide2.com" target="_blank"><img src="src/static/image/bigbar2.jpg"/></a></li>
							<li><a href="http://www.SuperSlide2.com" target="_blank"><img src="src/static/image/bigbar3.jpg"/></a></li>
							<li><a href="http://www.SuperSlide2.com" target="_blank"><img src="src/static/image/bigbar4.jpg"/></a></li>
					</ul>
