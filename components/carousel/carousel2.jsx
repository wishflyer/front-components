...
var Carousal = React.createClass({
	...
	componentDidMount: function() {
		...
		var zd_url = "url("+"../../../../static/image/img/bg_visual_grid.png"+")";
		$('.carousel2_zd').css({ 
			"z-index":"3",
			"background":zd_url,
			"_background":"url('')",
	...
	render: function() {
		...
		<div className='carousel2'>
			...
			<div className='carousel2_content_group'>
				...
				<div className='carousel2_content' style={{"background":"url(../../../../static/image/img/1.jpg) no-repeat left"}}>
				...
				<div className='carousel2_content' style={{"background":"url(../../../../static/image/img/2.jpg) no-repeat left"}}>
					<div className='carousel2_container'>
				...
				<div className='carousel2_content' style={{"background":"url(../../../../static/image/img/3.jpg) no-repeat left"}}>
					<div className='carousel2_container'>
